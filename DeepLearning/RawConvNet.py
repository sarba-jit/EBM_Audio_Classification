...
$python RawConvNet.py > saved_model/RawConvNet.txt
This code generates the audio classifcation model with 'custom' layer and saves it. Replace the n in the 
...
model.fit(X, Y, n_epoch=100, validation_set=0.3, snapshot_step=400, shuffle= True,
          show_metric=True, batch_size=128,run_id='RawConvNet')

model.save('saved_model/RawConvNet')