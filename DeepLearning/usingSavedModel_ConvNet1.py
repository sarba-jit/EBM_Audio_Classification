...
$python usingSavedModel_ConvNet1.py
This code is used to validate our ConvNet1 model by testing it against the out of sample data. 
...
model.load('saved_model/ConvNet1')
