...
$python usingSavedModel_ConvNet2.py
This code is used to validate our ConvNet2 model by testing it against the out of sample data. 
...
model = tflearn.DNN(network12, tensorboard_verbose=0)

model.load('saved_model/ConvNet2')
